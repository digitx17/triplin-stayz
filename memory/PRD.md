...
- 2026-09-25 (real contacts + email alerts): contact content updated to real values (digitalvaibhav529@gmail.com, linkedin.com/in/vaibhavkanhere/, wa.me/917058126249); enquiry email alerts wired via Emergent managed email (EMERGENT_EMAIL_KEY/EMAIL_FROM_NAME/EMAIL_REPLY_TO/OWNER_EMAIL in backend/.env) — every /api/contact submission fire-and-forget emails the owner with visitor name/email/message (guardrail-gated template, escaped, never blocks the save); details list block removed from ContactSection
